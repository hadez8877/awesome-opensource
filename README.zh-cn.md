...
- [移动应用](#移动应用)
  ...
  - [视频与流媒体](#视频与流媒体)
- [安全](#安全)
  - [容器与 Kubernetes 安全](#容器与-kubernetes-安全)
  - [终端与运行时安全](#终端与运行时安全)
  - [网络安全与监控](#网络安全与监控)
  - [隐私与匿名](#隐私与匿名)
  - [逆向工程与渗透测试](#逆向工程与渗透测试)
  ...
  - [漏洞扫描与分析](#漏洞扫描与分析)
- [自托管](#自托管)
  - [开发平台与 Git 服务](#开发平台与-git-服务)
  - [DNS、网络与隐私](#dns网络与隐私)
  - [Homelab 与服务器管理](#homelab-与服务器管理)
  - [媒体服务器与流媒体](#媒体服务器与流媒体)
  - [监控与可用性](#监控与可用性)
  - [密码管理器与认证](#密码管理器与认证)
  - [照片与文件管理](#照片与文件管理)
  - [RSS、稍后阅读与知识](#rss稍后阅读与知识)
- [软件 / SaaS](#软件--saas)
  - [分析与监控](#分析与监控)
  - [自动化与内部工具](#自动化与内部工具)
  - [通讯与支持](#通讯与支持)
  ...
  - [效率与协作](#效率与协作)
- [Web 开发](#web-开发)
  - [Angular UI 库](#angular-ui-库)
  - [代码编辑器](#代码编辑器)
  - [设计工具](#设计工具)
  - [图标](#图标)
  - [React UI 库](#react-ui-库)
  - [UI 组件](#ui-组件)
  - [Vue UI 库](#vue-ui-库)
...
- [Ivy Tendril](https://github.com/Ivy-Interactive/Ivy-Tendril) - 拥有精美 UI 的开源智能体软件工厂，可为你处理并行 Git worktrees，并配备程序化验证和快速审查循环。
...
- [Morphicons](https://github.com/guillermolg00/morphicons) - 采用弹簧物理效果的通用图标变形库，用于在基于描边的图标之间进行动画过渡。
...
- [Streamdown](https://github.com/vercel/streamdown) - 支持流式 AI 生成内容的 Markdown 渲染 React 组件。
...
- [Drawably](https://github.com/Danilaa1/drawably) - 带有动画钢笔素描笔触和每次挂载时全新随机效果的手绘风格 UI 控件。
