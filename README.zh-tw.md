...
| 類別            | 描述                                                                                                                                                              | 快速跳轉                         |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
| Backend / BaaS  | 後端服務、API、認證和 Backend-as-a-Service 的工具與平台，如 Firebase、Supabase 以及適用於 Node.js 和其他運行時的框架。                                             | [點擊查看](#backend--baas)      |
| CLI 工具        | 提升效率、檔案管理、系統監控、現代化 Shell 和日常開發工作流程自動化的命令列工具。                                                                                  | [點擊查看](#cli-工具)           |
| 資料庫          | 適用於不同場景和擴展需求的關聯式、NoSQL、圖、搜尋、向量和時序資料庫系統。                                                                                          | [點擊查看](#資料庫)             |
| DevOps          | 現代雲端部署的基礎設施即程式碼、Kubernetes 編排、CI/CD、監控、網路和安全。                                                                                          | [點擊查看](#devops)             |
| 行動應用        | 跨平台行動開發的框架和應用，包括瀏覽器、效率工具、多媒體和通訊應用。                                                                                               | [點擊查看](#行動應用)           |
| 安全            | 容器、網路、端點、隱私、逆向工程和漏洞管理的安全工具。                                                                                                            | [點擊查看](#安全)               |
| 自架設          | 可以部署在自有基礎設施上的軟體，包括 Git 平台、DNS、媒體伺服器、監控和檔案管理。                                                                                   | [點擊查看](#自架設)             |
| 軟體 / SaaS     | 完整的應用，涵蓋分析、自動化、通訊、文件、儲存和團隊協作。                                                                                                        | [點擊查看](#軟體--saas)         |
| Web 開發        | 前端和全栈 Web 開發的框架、UI 函式庫、程式碼編輯器、設計工具和資源。                                                                                               | [點擊查看](#web-開發)           |
