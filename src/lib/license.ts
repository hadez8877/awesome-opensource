...
export function hasLicenseFileName(fileName: string) {
...
export function isApache2License(licenseContent: string) {
...
export function isGplV3License(licenseContent: string) {
 ...
 * @returns {boolean}
 */
export function isMitLicense(licenseContent: string) {
...
export function isLgplV3License(licenseContent: string) {
