...
| الفئة | الوصف | الوصول السريع |
|-------|-------|---------------|
| Backend / BaaS | أدوات ومنصات لخدمات الخلفية، واجهات برمجة التطبيقات، والمصادقة، وBackend-as-a-Service مثل Firebase وSupabase وأطر عمل Node.js والبيئات الأخرى. | [انقر هنا](#backend--baas) |
| أدوات CLI | أدوات سطر أوامر للإنتاجية، وإدارة الملفات، ومراقبة النظام، والأطراف الحديثة، وأتمتة سير العمل اليومي. | [انقر هنا](#أدوات-cli) |
| قواعد البيانات | أنظمة قواعد البيانات العلائقية، وNoSQL، والرسوم البيانية، والبحث، والمتجهات، والسلاسل الزمنية لحالات استخدام مختلفة واحتياجات التوسع. | [انقر هنا](#قواعد-البيانات) |
| DevOps | البنية التحتية ك código، وتنسيق Kubernetes، وCI/CD، والمراقبة، والشبكات، والأمن لنشر السحابة الحديثة. | [انقر هنا](#devops) |
| تطبيقات الجوال | أطر عمل وتطبيقات لتطوير الجوال متعدد المنصات، بما في ذلك المتصفحات والإنتاجية والوسائط المتعددة والاتصالات. | [انقر هنا](#تطبيقات-الجوال) |
| الأمان | أدوات أمان للحاويات والشبكات والنهايات وهندسة العكس وإدارة الثغرات الأمنية. | [انقر هنا](#الأمان) |
| الاستضافة الذاتية | البرمجيات التي يمكنك استضافتها على بنيتك التحتية الخاصة، بما في ذلك منصات Git وDNS وخوادم الوسائط والمراقبة وإدارة الملفات. | [انقر هنا](#الاستضافة-الذاتية) |
| البرمجيات / SaaS | تطبيقات كاملة للتحليلات والأتمتة والاتصالات والتوثيق والتخزين وإنتاجية الفريق. | [انقر هنا](#البرمجيات--saas) |
| تطوير الويب | أطر عمل، ومكتبات واجهات المستخدم، ومحررات الكود، وأدوات التصميم، وموارد لتطوير الويب الأمامي والكامل. | [انقر هنا](#تطوير-الويب) |
