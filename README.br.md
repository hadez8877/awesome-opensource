...
- [Ivy Tendril](https://github.com/Ivy-Interactive/Ivy-Tendril) - Fábrica de software agêntica de código aberto com uma UI incrível que gerencia Git worktrees paralelas para você, completa com verificações programáticas e loops de revisão rápidos.
...
- [Morphicons](https://github.com/guillermolg00/morphicons) - Biblioteca universal de morphing de ícones com física de mola para animar entre ícones baseados em traços.
...
- [Streamdown](https://github.com/vercel/streamdown) - Componente React para renderizar Markdown com suporte a streaming de conteúdo gerado por IA.
...
- [Drawably](https://github.com/Danilaa1/drawably) - Controles UI desenhados à mão com traços animados de esboço a caneta e nova aleatoriedade a cada montagem.
...
- [Goey Toast](https://github.com/anl331/goey-toast) - Biblioteca leve e personalizável de notificações toast para aplicações web modernas.
