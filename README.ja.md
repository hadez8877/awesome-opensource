...
| カテゴリ | 説明 | ショートカット |
|---|---|---|
| バックエンド / BaaS | Firebase、Supabase、Node.jsやその他のランタイム向けフレームワークなど、バックエンドサービス、API、認証、Backend-as-a-Serviceのツールとプラットフォーム。 | [こちらをクリック](#バックエンド--baas) |
| CLIツール | 生産性、ファイル管理、システム監視、モダンシェル、開発者の日常的なワークフロー自動化のためのコマンドラインユーティリティ。 | [こちらをクリック](#cliツール) |
| データベース | リレーショナル、NoSQL、グラフ、検索、ベクトル、時系列データベースシステム。 | [こちらをクリック](#データベース) |
| DevOps | インフラストラクチャ as Code、Kubernetesオーケストレーション、CI/CD、監視、ネットワーキング、セキュリティ。 | [こちらをクリック](#devops) |
| モバイルアプリ | クロスプラットフォーム開発のフレームワークとアプリケーション。 | [こちらをクリック](#モバイルアプリ) |
| セキュリティ | コンテナ、ネットワーク、エンドポイント、プライバシー、リバースエンジニアリング、脆弱性管理のためのセキュリティツール。 | [こちらをクリック](#セキュリティ) |
| セルフホスト | Gitプラットフォーム、DNS、メディアサーバー、監視、ファイル管理など、自前のインフラストラクチャでホストできるソフトウェア。 | [こちらをクリック](#セルフホスト) |
| ソフトウェア / SaaS | 分析、自動化、コミュニケーション、ドキュメント、ストレージ、チームの生産性のための完全なアプリケーション。 | [こちらをクリック](#ソフトウェア--saas) |
| Web開発 | フロントエンドおよびフルスタックWeb開発のためのフレームワーク、UIライブラリ、コードエディタ、デザインツール。 | [こちらをクリック](#web開発) |
